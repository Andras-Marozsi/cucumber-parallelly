...
const { PickleFilter, getTestCasesFromFilesystem } = require('@cucumber/cucumber');
  ...
  static getScenarios(tagsToGet, weightingTags, fPaths = ['./features']) {
    ...
    function getFeaturesByTagExpression() {
      ...
      return streamToArray(GherkinStreams.fromPaths(featuresPaths, {
        ...
        const pickleFilter = (() => new (require('@cucumber/cucumber/lib/pickle_filter')).default({ tagExpression: tagExpression }))();
