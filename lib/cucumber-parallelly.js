...
var ScenariosOnWorkerPool = require('./cucumber-parallelly/parallel_executor.js'),
  args = require('yargs').usage('$0 <cmd> [args]').option('tags', {
    alias: 't',
    //default: '',
...
config.weightingTags = config.weightingTags || {
  pattern: '',
  default: 1
};
...
config.cucumberOpts = config.cucumberOpts || "--require features/step_definitions " + "--require features/support/env.js " + "--require features/support/world.js " + "--require features/support/hooks.js ";
if (args.verbose) {
  console.log(config);
}
function execution() {
