...
describe('lib/cucumber-parallelly/helper.js', function () {
  ...
  describe('getScenarios', function () {
    it("should not return scenarios if features path does not contain features", function *() {
      assert.deepEqual(yield (helper.getScenarios({tags: []}, {pattern: '', default: 1}, ['./lib'])), []);
    })
    it("should return all scenarios from a specific feature path", function *() {
      ...
      assert.deepEqual(yield (helper.getScenarios({tags: []}, {pattern: '', default: 1}, ['./test/features'])), expectedArray);
    })
    it("should return all scenarios for empty array of tags", function *() {
      ...
      assert.deepEqual(yield (helper.getScenarios({tags: []}, {pattern: '', default: 1})), expectedArray);
    });
    it("should return all scenarios for tag '@all'", function *() {
      ...
      assert.deepEqual(yield (helper.getScenarios({tags: ['@all']}, {pattern: '', default: 1})), expectedArray);
    });
    it("should return a subset of scenarios for tag '@evens'", function *() {
      ...
      assert.deepEqual(yield (helper.getScenarios({tags: ['@evens']}, {pattern: '', default: 1})), expectedArray);
    });
    it("should return a subset of scenarios for tag '@scenario2 @acceptance'", function *() {
      ...
      assert.deepEqual(yield (helper.getScenarios({tags: ['@evens', "@acceptance"]}, {
        pattern: '',
        default: 1
      })), expectedArray);
    });
    it("should return a subset of scenarios for tag '@scenario2 ~@regression'", function *() {
      ...
      assert.deepEqual(yield (helper.getScenarios({tags: ['@scenario2', "~@regression"]}, {
        pattern: '',
        default: 1
      })), expectedArray);
    });
    it("should return no scenarios for tag 'all'", function *() {
      assert.deepEqual(yield (helper.getScenarios({tags: ['all']}, {pattern: '', default: 1})), []);
    });
  });
